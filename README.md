...
We welcome input from tech community please let us know how we can improve this plugin. Do not hesitate to ask us questions on the [issues](https://github.com/PhazeRoOman/thawani_gw/issues) page.

## License

Distributed under the MIT License. See [license](https://github.com/PhazeRoOman/thawani-for-woocommerce/blob/master/LICENSE.md) for more information. 
